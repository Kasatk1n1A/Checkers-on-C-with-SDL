...
// // Инициализация бота с заданным уровнем сложности
// void init_bot(Bot* bot, int difficulty) {
...
//                 Bot tempBot = { bot->difficulty };
//                 bot_make_move(tempBoard, &tempBot, player, CheckersBoard);
